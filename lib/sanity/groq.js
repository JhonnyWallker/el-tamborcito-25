...
// Get all video
export const noticiaquery = groq`
*[_type == "noticia"] | order(publishedAt desc, _createdAt desc) {
  _id,
  _createdAt,
  publishedAt,
  mainImage {
...
`;
// Get all publicidad
export const publicidadquery = groq`
*[_type == "publicidad"] | order(publishedAt desc, _createdAt desc) {
  _id,
  _createdAt,
  publishedAt,
  mainImage {
...
`;
export const paginatedquerynoticias = groq`
*[_type == "noticia"] | order(publishedAt desc, _createdAt desc) [$pageIndex...$limit] {
  ...,
  author->,
  categories[]->
}
...
`;
export const singlequerynoticia = groq`
...
export const pathquerynoticia = groq`
