              ...
              <div className="flex flex-wrap justify-between md:flex-nowrap md:gap-10">
                ...
                <div className="flex w-full items-center justify-between md:w-auto">
                  <Link href="/" className="w-36 dark:hidden">
                    <img src={"https://res.cloudinary.com/dm4wfkipp/image/upload/v1747337756/el-tamborcito-2000px_upzxt9.png"} />
                  </Link>
                  <Link href="/" className="hidden w-36 dark:block">
                    <img src={"https://res.cloudinary.com/dm4wfkipp/image/upload/v1747340414/el-tamborcito-b-2000px_ymllbu.png"} />
                  </Link>
                  <Disclosure.Button
